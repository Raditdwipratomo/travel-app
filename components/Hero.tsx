    ...
    <section className="max-container padding-container flex flex-col gap-20 py-10 pb-32 md:gap-28 lg:py-20 xl:flex-row">
      ...
      <div className="relative z-20 flex flex-1 flex-col xl:w-1/2">
        ...
        <p className="regular-16 mt-6 text-gray-30 xl:max-w-[520px]">
          We want to on each on your journeys seeking the satisfaction of seeing
          the incorruptible beauty of nature. We can help you on an adventure
      ...
      <div className="relative flex flex-1 items-start ">
        <div className="relative flex flex-col z-20 w-[268px] gap-8 rounded-3xl bg-green-90 px-7 py-8">
          ...
          <div className="flexBetween">
              <div className="flex flex-col">
                ...
                <p className="bold-20 text-white">172.8 mi</p>
              </div>
